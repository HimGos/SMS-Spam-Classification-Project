...
TRANSFORMED_FILE_NAME = "transformed_file.csv"
...
class DataValidationConfig:
    ...
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.base_file_path = os.path.join("SMSSpamCollection.csv")
...
class DataTransformationConfig:
    ...
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.transformed_file_path = os.path.join(self.data_transformation_dir, "transformed_arrays", TRANSFORMED_FILE_NAME.replace("csv", "npz"))
